# In this Program there are 2 buttons named b67 and b76 there positions are interchanged..... bhaiya maaf kar dena

from PyQt5 import QtCore, QtGui, QtWidgets
from algo.chessalgo import possibilities
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.b76.setGeometry(QtCore.QRect(700, 600, 100, 100))
        font = QtGui.QFont()
        font.setPointSize(16)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.b76.setText(_translate("MainWindow", "wP"))
        ...
        self.b67.setText(_translate("MainWindow", "wKn"))
    ...
    def actionb00(self):
        ...
        p = possibilities(pos,active_pos)
        for i in range(8):
            for j in range(8):
                if p[i][j] == 1:
                    self.pos_color(i, j)
    ...
    def position_array(self):
        self.position_arr = [
            ...
            [self.b60.text(),self.b61.text(),self.b62.text(),self.b63.text(),self.b64.text(),self.b65.text(),self.b66.text(),self.b76.text()],
            [self.b70.text(),self.b71.text(),self.b72.text(),self.b73.text(),self.b74.text(),self.b75.text(),self.b67.text(),self.b77.text()]
        ]   
    ...
    def pos_color(self,i,j):
        update_color=[
            ...
            [self.b60,self.b61,self.b62,self.b63,self.b64,self.b65,self.b66,self.b76],
            [self.b70,self.b71,self.b72,self.b73,self.b74,self.b75,self.b67,self.b77]
         ]
    ...
    def update_array(self,position_arr):
        self.position_arr = [
            ...
            [self.b10.text(position_arr[1][0]),self.b11.text(position_arr[1][1]),self.b12.text(position_arr[1][2]),self.b13.text(position_arr[1][3]),self.b14.text(position_arr[1][4]),self.b15.text(position_arr[1][5]),self.b16.text(position_arr[1][6]),self.b17.text(position_arr[1][7])],
            
            [self.b20.text(position_arr[2][0]),self.b21.text(position_arr[2][1]),self.b22.text(position_arr[2][2]),self.b23.text(position_arr[2][3]),self.b24.text(position_arr[2][4]),self.b25.text(position_arr[2][5]),self.b26.text(position_arr[2][6]),self.b27.text(position_arr[2][7])],
            
            [self.b30.text(position_arr[3][0]),self.b31.text(position_arr[3][1]),self.b32.text(position_arr[3][2]),self.b33.text(position_arr[3][3]),self.b34.text(position_arr[3][4]),self.b35.text(position_arr[3][5]),self.b36.text(position_arr[3][6]),self.b37.text(position_arr[3][7])],
            
            [self.b40.text(position_arr[4][0]),self.b41.text(position_arr[4][1]),self.b42.text(position_arr[4][2]),self.b43.text(position_arr[4][3]),self.b44.text(position_arr[4][4]),self.b45.text(position_arr[4][5]),self.b46.text(position_arr[4][6]),self.b47.text(position_arr[4][7])],
            
            [self.b50.text(position_arr[5][0]),self.b51.text(position_arr[5][1]),self.b52.text(position_arr[5][2]),self.b53.text(position_arr[5][3]),self.b54.text(position_arr[5][4]),self.b55.text(position_arr[5][5]),self.b56.text(position_arr[5][6]),self.b57.text(position_arr[5][7])],
            
            [self.b60.text(position_arr[6][0]),self.b61.text(position_arr[6][1]),self.b62.text(position_arr[6][2]),self.b63.text(position_arr[6][3]),self.b64.text(position_arr[6][4]),self.b65.text(position_arr[6][5]),self.b66.text(position_arr[6][6]),self.b76.text(position_arr[7][6])],
            
            [self.b70.text(position_arr[7][0]),self.b71.text(position_arr[7][1]),self.b72.text(position_arr[7][2]),self.b73.text(position_arr[7][3]),self.b74.text(position_arr[7][4]),self.b75.text(position_arr[7][5]),self.b67.text(position_arr[6][7]),self.b77.text(position_arr[7][7])]
        ]
